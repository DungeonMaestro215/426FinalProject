...
export default class View {
    ...
    constructor() {
        ...
        document.getElementById('addTower').addEventListener('click', this.toggleTowerPlacement.bind(this));
    }
    ...
    toggleTowerPlacement() {
        if(!(this.placingTower = !this.placingTower)) {
            this.enemy_canvas.removeEventListener('mousedown', this.renderTowerFromMouseEvent);
        } else {
            this.enemy_canvas.addEventListener('mousedown', this.renderTowerFromMouseEvent);
        }
    }
    ...
    initiateLossScreen() {
        ...
        const die = (timestamp) => {
            ...
            if(o > 0.2) {
                foreground_ctx.fillText('YOU DIED', this.foreground.width/2, this.foreground.height/2);
            }
